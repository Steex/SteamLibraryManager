...
- Пользователь может переносить игры между библиотеками. Никаких действий на этом этапе
  не происходит, но при перемещении обновляются объем каждй библиотеки и свободное место.
  Даже если места на диске недостаточно для новых игр в библиотеке, это не мещает добавлять игры,
